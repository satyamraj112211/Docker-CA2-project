    ...
    >
      <div className="container relative">
        ...
        <h1 className="text-6xl md:text-7xl lg:text-8xl font-medium text-center mt-6">
          Secure note-taking, engineered for privacy
        </h1>
        <p className="text-center text-xl text-white/50 mt-8 max-w-2xl mx-auto">
          Your ideas deserve top-tier protection. Secure-NoteBook combines powerful encryption
          features with an intuitive interface that keeps your thoughts safe, organized, and
